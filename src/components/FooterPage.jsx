...
//           {/* <!-- Text --> */}
//           <div class="mb-6">
//             <h5 class="mb-2 font-bold uppercase">Explore Our microWorld</h5>

//             <p class="mb-4">

//             Explore the world of technology with microWorld and discover innovation!
//             </p>
//           </div>
...
//         <div class=" p-6 text-center bg-white/10 flex justify-center items-center">
