...
//                                 <img className="h-10 object-cover" src="https://stackoverflow.design/assets/img/logos/so/logo-stackoverflow.svg" alt="Store Logo" />
//                             </h3>
//                         </a>
//                     </div>
...
//                         <p className="flex text-gray-600 hover:text-blue-500 cursor-pointer transition-colors duration-300"></p>
//                         {/* <Link to="about"></Link> */}

//                         <a className="flex text-gray-600 hover:text-blue-500 cursor-pointer transition-colors duration-300">Home</a>
//                         <a className="flex text-gray-600 cursor-pointer transition-colors duration-300 font-semibold text-blue-600">About Us</a>
//                         <a className="flex text-gray-600 hover:text-blue-500 cursor-pointer transition-colors duration-300">Contact Us</a>
...
const NavBar = () => {
  return (
  <ol>
<li> <Link to="/home" className="text-blue-500 hover:text-blue-700">Home</Link></li>
